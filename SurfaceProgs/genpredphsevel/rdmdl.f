...
c120   FORMAT(I13,F10.0,E15.7,2F10.0,3I2)
...
c      DO I = 1, ILAY
c      if (I.le.42) then
c      READ(5,FMT)  HI(I),RHOI(I),VPI(I),VSI(I)
c      else
c      READ(5,111)  HI(I),RHOI(I),VPI(I),VSI(I)
c      endif
c      enddo
      do i = 1, ilay
        read(5,*) hi(i),rhoi(i),vpi(i),vsi(i)
c	write(*,*) hi(i),rhoi(i),vpi(i),vsi(i)
      enddo

      
c111   format(F6.2,F8.4, F9.4,F7.4)
  ...
  200 CONTINUE
      read(5,*) ndiv,dmax,mpunch
c      write(*,*) ndiv,dmax,mpunch
c      READ(5,210)  NDIV,DMAX,MPUNCH                         
c  210 FORMAT(I5,F10.0,I2)
C
      CALL  DIVIDE
